...
type AppVersion = 'preact-signals' | 'preact-optimized' | 'useRefState' | 'optimized';
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
          <button 
            ...
            style={{
              padding: '5px 10px',
              backgroundColor: currentApp === 'preact-signals' ? '#007acc' : '#f0f0f0',
          ...
          <button 
             ...
             style={{
               padding: '5px 10px',
               backgroundColor: currentApp === 'preact-optimized' ? '#007acc' : '#f0f0f0',
          ...
          <button 
            ...
            style={{
              padding: '5px 10px',
              backgroundColor: currentApp === 'useRefState' ? '#007acc' : '#f0f0f0',
          ...
          <button 
            ...
            style={{
              padding: '5px 10px',
              backgroundColor: currentApp === 'optimized' ? '#007acc' : '#f0f0f0',
